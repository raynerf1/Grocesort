...
for indice, ProductoABuscar in enumerate(ArrayProductos):
    ...
    while not error and casilla < 10:
        try:
            ...
            XPathNombreProducto = '/html/body/div[1]/div/div[1]/div[2]/main/div[2]/div/div/div[2]/div/div/div[' + str(casilla) + ']/div[2]/div[2]/div[1]/h3/a'
            XPathSelectorPrecio = '/html/body/div[1]/div/div[1]/div[2]/main/div[2]/div/div/div[2]/div/div/div[' + str(casilla) + ']/div[2]/div[2]/div[1]/div[3]/strong'
            xpathDetalle = '/html/body/div[1]/div/div[1]/div[2]/main/div[2]/div/div/div[2]/div/div/div[' + str(casilla) + ']/div[2]/div[2]/div[1]/div[2]/div/span[2]'
            ...
            DetalleProductoDFE = driver.find_element("xpath", xpathDetalle)

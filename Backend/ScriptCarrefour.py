...
for indice, ProductoABuscar in enumerate(ArrayProductos):
    ...
    if PosicionArray < 75:
        driver.find_element("xpath", '/html/body/section/header/div[1]/div/input[3]').send_keys(ProductoABuscar + ' carrefour')
    ...
    while not error and casilla < 10:
        try:
            ...
            xPathDetalle = '/html/body/section/main/div/section/section/article[' + str(casilla) + ']/div/div[2]/span'
